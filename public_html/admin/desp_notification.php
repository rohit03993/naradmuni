...
$orderby = " ORDER BY n_id desc";
$sql = "SELECT * from notification" . $queryCondition;
$paginationlink = "desp_notification.php?page=";	
...
?>
                        ...
                        <table id="myTable" class="table table-bordered">
                            ...
                            <td><img src="<?php echo $faq[$k]["image"]; ?>" width="100"></td>
