...
if(isset($_POST['add']))
                    {       
                        ...
                        if($parent==0){
                                ...
                                $qry="insert into news (short,menu,maincat,cat_url,metat,metad) values('$short','$menu','$page','$linkname','$metat','$metad')";
                                
                            }else{
                                
                               $qry="insert into news (short,menu,maincat,parent,cat_url,metat,metad) values('$short','$menu','$page','$parent','$linkname','$metat','$metad')";
                            }
                                 ...
                                 if($ex>0)

                                    {
                                        ...
                                        nm_js_notice('Sorry, there was an error uploading your file.', 'pages.php', 'error');
                                    }
                            }
?>
<!DOCTYPE html>
...
<div class="container-fluid page-content">
        ...
        <a href="add_pages.php" class="btn btn-success"><span class="fa fa-plus"></span> Add New </a>
        </div> 
    ...
    <option value="prev-next">Display Prev Next Only</option>
           ...
           <div class="col-md-8 form-group group">
            ...
            <div class="col-md-4 form-group group">
              ...
              <select class="custom-select" onChange="changePagination(this.value);" id="page">
