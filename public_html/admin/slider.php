...
<div id="content">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a> <i class="fa fa-angle-right"></i> Manage Slider</li>
            </ol>
<div class="container-fluid page-content">
    <div class="row">
        ...
        <a href="add_slider.php" class="btn btn-success"><span class="fa fa-plus"></span> Add Slider </a>
        </div> 
