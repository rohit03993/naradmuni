...
<div id="content">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a> <i class="fa fa-angle-right"></i> Idea</li>
            </ol>
<div class="container-fluid page-content">
    ...
    <option value="prev-next">Display Prev Next Only</option>
           ...
           <div class="col-md-6 form-group group">
              ...
              <input class="form-control"  type="text" onChange="changePagination(this.value);" id="name" autocomplete="off">
            </div>
